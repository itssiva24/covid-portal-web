...
import { Button, TextField, Paper, Typography, LinearProgress } from '@material-ui/core';
...
function NewRequest() {
	...
	const { handleFile, requestForm, handleInput, handleSubmit, uploading } = useUploadRequest(
		authUser
	);
